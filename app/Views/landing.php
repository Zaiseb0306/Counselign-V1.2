...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('css/landing.css?v=1.3') ?>">
    <link rel="stylesheet" href="<?= base_url('css/landing_vibe.css?v=3') ?>">
</head>

<body class="landing-vibe-page">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav nav-links">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('services') ?>" style="color:white;">
                    <i class="fas fa-handshake" style="color:white;"></i> Services
                </a>
            </li>

            <li id="openContactModal" class="nav-item">
                <a class="nav-link" href="#" style="color:white;">
                    <i class="fas fa-envelope" style="color:white;"></i> Contact
                </a>
            </li>

            <li id="openLoginModal" class="nav-item">
                <a class="nav-link" href="#" style="color:white;">
                    <i class="fas fa-user-circle" style="color:white;"></i> Login
                </a>
            </li>

            <li id="openSignUpModal" class="nav-item">
                <a class="nav-link" href="#" style="color:white;">
                    <i class="fas fa-user-plus" style="color:white;"></i> Signup
                </a>
            </li>
    ...
    <div class="navbar-drawer d-lg-none" id="navbarDrawer">
        <div class="drawer-header d-flex justify-content-between align-items-center p-3 text-white">
    ...
    <main class="lv-main">
        <div class="lv-container">
            ...
            <section class="appt-hero" aria-labelledby="lv-hero-title">
                <h2 class="page-title" id="lv-hero-title">Your Future Starts Here</h2>
                <p class="appt-hero-sub">Your voice matters. Our counseling services are a safe space where your thoughts and feelings stay confidential. Seeking help is a sign of strength.</p>
            </section>


            <section class="rpt-panel" aria-labelledby="lv-features-title">
                <h3 class="rpt-section-title" id="lv-features-title">Why Choose Us?</h3>
                <div class="row g-4">
                    <div class="col-md-4">
                        <article class="pv-feature-card">
                            <div class="pv-feature-icon">
                                <img src="<?= base_url('Photos/MISC/high_five.png') ?>" alt="" width="36" height="36" />
                            </div>
                            <h5>Personalized Guidance</h5>
                            <p>Tailored advice to match your unique strengths and aspirations.</p>
                        </article>
                    </div>
                    <div class="col-md-4">
                        <article class="pv-feature-card">
                            <div class="pv-feature-icon">
                                <img src="<?= base_url('Photos/MISC/protection.png') ?>" alt="" width="36" height="36" />
                            </div>
                            <h5>Your Privacy Matters</h5>
                            <p>Everything you share stays safe and secure. Express yourself freely—we never share your information without consent.</p>
                        </article>
                    </div>
                    <div class="col-md-4">
                        <article class="pv-feature-card">
                            <div class="pv-feature-icon">
                                <img src="<?= base_url('Photos/MISC/mental_health.png') ?>" alt="" width="36" height="36" />
                            </div>
                            <h5>Experienced Counselors</h5>
                            <p>Seasoned professionals with deep knowledge in student wellness and guidance.</p>
                        </article>
                    </div>
                </div>
            </section>

            <section class="lv-cta" aria-labelledby="lv-cta-title">
                <h4 id="lv-cta-title">Ready to take the next step?</h4>
                <p>University guidance counseling—confidential, accessible, and here for you.</p>
                <div class="lv-cta-actions">
                    <button type="button" class="btn btn-light" onclick="document.getElementById('openSignUpModal').click()">Create account</button>
                    <button type="button" class="btn btn-outline-light" onclick="document.getElementById('openLoginModal').click()">Sign in</button>
                    <button type="button" class="btn btn-outline-light" id="heroContactBtn">Contact us</button>
                </div>
            </section>
    ...
    <div class="modal fade appt-vibe-modal" id="counselorInfoModal" tabindex="-1" aria-labelledby="counselorInfoModalLabel" aria-hidden="true">
    ...
    <!-- LOGIN MODAL -->
    <!-- LOGIN MODAL -->
    <div class="modal fade appt-vibe-modal" id="loginModal" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header appointment-modal-header">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <input type="email" id="loginIdentifierInput" placeholder="Email" class="form-control" autocomplete="email">
                    </div>
                    ...
                    <div id="loginWarning" class="text-danger mb-3 d-none">
                        <p id="loginIdentifierError" class="d-none">*Please enter a valid email</p>
    ...
    <!-- SIGN-UP MODAL -->
    <div class="modal fade appt-vibe-modal" id="signUpModal" tabindex="-1" aria-labelledby="signUpModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header appointment-modal-header">
    ...
    <div class="modal fade appt-vibe-modal" id="forgotPasswordModal" tabindex="-1" aria-labelledby="forgotPasswordModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header appointment-modal-header">
    ...
    <!-- CODE ENTRY MODAL -->
    <div class="modal fade appt-vibe-modal" id="codeEntryModal" tabindex="-1" aria-labelledby="codeEntryModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header appointment-modal-header">
    ...
    <!-- NEW PASSWORD MODAL -->
    <div class="modal fade appt-vibe-modal" id="newPasswordModal" tabindex="-1" aria-labelledby="newPasswordModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header appointment-modal-header">
    ...
    <div class="modal fade appt-vibe-modal" id="resendResetCodeModal" tabindex="-1" aria-labelledby="resendResetCodeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header appointment-modal-header">
    ...
    <div class="modal fade appt-vibe-modal" id="termsModal" tabindex="-1" aria-labelledby="termsModalLabel" aria-hidden="true">
    ...
    <!-- CONTACT MODAL -->
    <div class="modal fade appt-vibe-modal" id="contactModal" tabindex="-1" aria-labelledby="contactModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header appointment-modal-header">
