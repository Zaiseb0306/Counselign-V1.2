...
<head>
    ...
    <title>My Feedback - Counselign</title>
    ...
    <link rel="stylesheet" href="<?= base_url('css/counselor/view_feedback.css') ?>">
    <link rel="stylesheet" href="<?= base_url('css/utils/vibe_topbar.css?v=3') ?>">
</head>

<body class="vf-page-body">
    <!-- Sidebar -->
    <aside class="sidebar" id="uniSidebar">
        <div class="sidebar-content">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="<?= base_url('counselor/pending-feedback/view-feedback') ?>" class="sidebar-link active" title="View Feedback">
            ...
            <div class="container-fluid px-4 vf-container">
                ...
                <?php if (!empty($negative_feedback)): ?>
                    <div class="vf-alert-attention" role="alert">
                        <h5><i class="fas fa-exclamation-triangle me-2"></i>Feedback Requiring Attention</h5>
                        <p>You have <?= count($negative_feedback) ?> feedback entries with negative sentiment. Consider reviewing these to improve your service.</p>
                    </div>
                <?php endif; ?>
    ...
    <script>
        document.getElementById('filterForm').addEventListener('submit', function(e) {
            ...
            window.location.href = '<?= base_url('counselor/pending-feedback/view-feedback') ?>?' + params;
        });

        document.getElementById('clearFilters').addEventListener('click', function() {
            window.location.href = '<?= base_url('counselor/pending-feedback/view-feedback') ?>';
        });
    </script>
</body>
