...

{
...

    {
        ...
        try {
            ...
            $this->notificationsModel->deleteAll($userId);



            // Update last_activity for clearing notifications

            $activityHelper = new UserActivityHelper();

            $activityHelper->updateCounselorActivity($userId, 'clear_notifications');
            ...
            log_message('error', 'Error deleting all counselor notifications: ' . $e->getMessage());

            return $this->failServerError('Failed to delete all notifications');
